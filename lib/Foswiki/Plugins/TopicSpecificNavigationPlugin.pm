...
# =========================
package Foswiki::Plugins::TopicSpecificNavigationPlugin;    # change the package name and $pluginName!!!
# =========================
...
$SHORTDESCRIPTION = 'This plugins introduces a new navigation type for each topic: It should be used to place things like related links, further readups etc.';
...
sub initPlugin {
    ...
    my $output = '<style type="text/css" media="all">@import url(\''.$pluginPubHome.'/topicspecificnav.css\');</style>';
